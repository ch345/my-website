...
function DitheredWaves({
  ...
  // Initialize uniforms with proper resolution on first render
  ...
  useEffect(() => {
    if (!mesh.current || !waveUniformsRef.current) return;

    // Create and attach shader material directly
    ...
    mesh.current.material = shaderMat;
  }, []);
